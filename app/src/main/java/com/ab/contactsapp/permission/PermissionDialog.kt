package com.ab.contactsapp.permission
...
class ReadContactPermissionTextProvider: PermissionTextProvider {
...
class WriteContactPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
